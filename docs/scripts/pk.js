...
function nextMember() {
  $( "#nextfronter" ).click(function() {  
    if (currentMember == 8) {
      ...
      // if there are only 5 fronters, remove the next button
      if (currentMember == totalFronters) {
    ...
    if (currentMember == 3) {
      ...
      document.getElementById("previous").innerText = "<"
      document.getElementById("next").innertext = ">"
      // if there are only 4 fronters, remove the next button
        if (parseInt(currentMember) == parseInt(totalFronters)) {
          console.log("[LOG] Hiding next button, at currentMember value of " + currentMember + ".")
          document.getElementById("next").innerText = ""
      }
      ...
      document.getElementById("previous").innerText = "<"
      document.getElementById("next").innertext = ">"
      // if there are only 3 fronters, remove the next button
        if (parseInt(currentMember) == parseInt(totalFronters)) {
          console.log("[LOG] Hiding next button, at currentMember value of " + currentMember + ".")
          document.getElementById("next").innerText = ""
      }
